function InitTurbine (wf, no_t, lifetime, pc) 

    for k=1:no_t
        V44 = WT ('V44', lifetime, k);
        V44.main_service_interval = 8760/2;
        ...
        V44.AddComponent (c_generator, 'generator');
        V44.AddComponent (c_electricsystem, 'electric_system');
        V44.AddComponent (c_controlsystem, 'control_system');
        V44.AddComponent (c_gearbox, 'gearbox');
        V44.AddComponent (c_hydraulics, 'hydraulic_system');
        
        wf.AddTurbine (V44);
        
        clear V44
        clear c_generator
        clear c_electricsystem
        clear c_controlsystem
        clear c_gearbox
        clear c_hydraulics
    end
end
